 ...
 * - Extends ResponseEntityExceptionHandler để xử lý chuẩn các Spring MVC exceptions
 * 
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        logWithContext("ERROR", "Method argument validation failed", ex, servletRequest != null ? servletRequest : ((ServletRequestAttributes) RequestContextHolder.currentRequestAttributes()).getRequest());
        ...
        ErrorResponse error = buildErrorResponse(ErrorCode.VALIDATION_FAILED, null, servletRequest != null ? servletRequest : ((ServletRequestAttributes) RequestContextHolder.currentRequestAttributes()).getRequest(), details);
